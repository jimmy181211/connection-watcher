...
public static partial class UiText
{
    private static readonly IReadOnlyDictionary<string, string> Chinese =
        new Dictionary<string, string>
        {
            ...
            ["SoftwareUpdatesHint"] = "仅在点击“立即检查”时连接GitHub；不会上传规则或日志，也不会自动下载或安装。",
            ["CheckNow"] = "立即检查",
            ...
            ["Privacy"] = "除非您手动检查更新，否则本工具不会联网；它不上传日志、不读取数据包内容，也不会自动封锁连接。",
            ["CreateRule"] = "新建监视规则",
            ["EditRule"] = "编辑监视规则",
            ["RuleType"] = "规则类型",
    ...
    private static readonly IReadOnlyDictionary<string, string> English =
        new Dictionary<string, string>
        {
            ...
            ["SoftwareUpdatesHint"] = "Contacts GitHub only when you select Check now. Rules and logs are not uploaded, and nothing is downloaded or installed automatically.",
            ["CheckNow"] = "Check now",
            ...
            ["Privacy"] = "This tool connects to the internet only when you manually check for updates. It does not upload logs, read packet contents, or block connections automatically.",
    ...
    private static readonly IReadOnlyDictionary<string, string> Spanish =
        new Dictionary<string, string>
        {
            ...
            ["SoftwareUpdatesHint"] = "Solo contacta con GitHub al pulsar Comprobar ahora. No sube reglas ni registros ni descarga o instala nada automáticamente.",
            ...
            ["Privacy"] = "Esta herramienta solo se conecta a Internet al comprobar actualizaciones manualmente. No sube registros, no lee paquetes ni bloquea conexiones automáticamente.",
